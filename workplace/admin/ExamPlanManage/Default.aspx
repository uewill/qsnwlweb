<%@ Page Language="C#" MasterPageFile="~/admin/MainPage/ItemMasterPage.master" AutoEventWireup="true"
    CodeFile="Default.aspx.cs" Inherits="admin_ExamPlanManage_Default" Title="订单管理" %>
            ...
            <td>
                <table class="maincon" width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#CCCCCC">
                    <tr>
                        ...
                        <th width="10%" background="../images/bg.gif" align="center">考点名称
                        </th>
                        <th width="10%" background="../images/bg.gif" align="center">考试时间
                        </th>
                        <th width="15%" background="../images/bg.gif" align="center">联系人
                        </th>

                        <th width="10%" background="../images/bg.gif" align="center">创建时间
                        </th>
                    ...
                    <asp:Repeater ID="rptBind" runat="server">
                        <ItemTemplate>
                            <tr>
                                ...
                                <td align="center">
                                    <a href="../ExamStudentManage/default.aspx?id=<%#Eval("id") %>">查看考生信息</a>
