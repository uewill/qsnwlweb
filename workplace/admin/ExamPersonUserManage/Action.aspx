        ...
        <PanelCollection>
            <dxrp:PanelContent runat="server">
                <table class="category" width="100%" align="center" style="line-height: 25px;">
                    <tr>
                        <td style="width: 100px; text-align: right;">姓名：
                        </td>
                    ...
                    <tr>
                        <td style="width: 100px; text-align: right;">出生日期：
                        </td>
                        <td style="text-align: left;">
                            <%=dataModel.Birthday%>
                        </td>
                    ...
                    <tr>
                        <td style="width: 100px; text-align: right; height: 37px;">性别：
                        </td>
                        <td style="text-align: left;">
                            <%=dataModel.Sex%>
                        </td>
                    ...
                    <tr>
                        <td style="width: 100px; text-align: right; height: 37px;">国籍：
                        </td>
                        <td style="text-align: left;">
                            <%=dataModel.Country%>
                        </td>
                    ...
                    <tr>
                        <td style="width: 100px; text-align: right; height: 37px;">民族：
                        </td>
                        <td style="text-align: left;">
                            <%=dataModel.Mingzu%>
                        </td>
                    ...
                    <tr>
                        <td style="width: 100px; text-align: right" valign="top">考生所在地：
                        </td>
                        <td style="text-align: left;">
                            <%=dataModel.Address%>
                        </td>
                    ...
                    <tr>
                        <td style="width: 100px; text-align: right" valign="top">报考专业：
                        </td>
                    ...
                    <tr>
                        <td style="width: 100px; text-align: right; height: 37px;">申报专业已有的最高级别：
                        </td>
                        <td>
                    ...
                    <tr>
                        <td style="width: 100px; text-align: right; height: 37px;">考生联系人：
                        </td>
                        <td>
                    ...
                    <tr>
                        <td style="width: 100px; text-align: right; height: 37px;">与考生关系：
                        </td>
                        <td>
                    ...
                    <tr>
                        <td style="width: 100px; text-align: right; height: 37px;">通讯地址：
                        </td>
                        <td>
                    ...
                    <tr>
                        <td style="width: 100px; text-align: right; height: 37px;">指导老师：
                        </td>
                        <td>
                            <%=dataModel.Zhidao%> 
                        </td>
