<%@ Page Language="C#" MasterPageFile="~/admin/MainPage/ItemMasterPage.master" AutoEventWireup="true"
    CodeFile="Default.aspx.cs" Inherits="admin_ExamPersonUserManage_Default" Title="订单管理" %>
            ...
            <td>
                <table class="maincon" width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#CCCCCC">
                    <tr>
                        ...
                        <th width="10%" background="../images/bg.gif" align="center">报考类型
                        </th>

                        <th width="10%" background="../images/bg.gif" align="center">报考等级
                        </th>
                        <th width="10%" background="../images/bg.gif" align="center">生日
                        </th>
                        <th width="10%" background="../images/bg.gif" align="center">性别
                        </th>
                        <th width="10%" background="../images/bg.gif" align="center">国籍/民族
                        </th>
                        <th width="10%" background="../images/bg.gif" align="center">报名日期
                        </th>
                    ...
                    <asp:Repeater ID="rptBind" runat="server">
                        <ItemTemplate>
                            <tr>
                                ...
                                <td align="center">
                                    <%# Eval("Country")%> / <%# Eval("Mingzu")%>
                                </td>
                                <td align="center">
                                    <%# Eval("CreateTime")%>
                                </td>
                                <td align="center">
                                    <a href="/exam/personal/PrintViewBy.aspx?id=<%#Eval("id") %>&fromadmin=admin" target="_blank">查看报考信息</a>
