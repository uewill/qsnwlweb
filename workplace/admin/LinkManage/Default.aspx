<%@ Page Language="C#" MasterPageFile="~/admin/MainPage/ItemMasterPage.master" AutoEventWireup="true"
    CodeFile="Default.aspx.cs" Inherits="admin_LinkManage_Default" Title="用户管理" %>
                                ...
                                <table>
                                    <tr>
                                        ...
                                        <td style="text-align: right;">
                                            <dxe:ASPxLabel ID="lblSearchName" Width="70px" runat="server" Text="内容：">
                                            </dxe:ASPxLabel>
                                        </td>
                                        <td>
                                ...
                                <asp:Repeater ID="rptBind" runat="server">
                                    <ItemTemplate>
                                        <tr>
                                           ...
                                           <td align="center">
                                              <%#GetUrl(Eval("logo"),Eval("isPictureOn")) %>
                                            </td>
                                            <td align="center">
                                                <%# Eval("linkUrl") %>
                                            </td>
