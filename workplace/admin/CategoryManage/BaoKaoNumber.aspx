<%@ Page Language="C#" MasterPageFile="~/admin/MainPage/ItemMasterPage.master" AutoEventWireup="true"
    CodeFile="BaoKaoNumber.aspx.cs" Inherits="admin_CategoryManage_BaoKaoNumber" ValidateRequest="false"
    Title="Untitled Page" %>
        ...
        <PanelCollection>
            <dxrp:PanelContent ID="PanelContent1" runat="server">
                <table class="category" width="100%" border="0" align="center" cellpadding="0" cellspacing="1">
                    <tr>
                        <td style="width: 100px; text-align: right">栏目名称：
                        </td>
                        <td style="text-align: left;">
                            <table>
                                <tr>
                                    ...
                                    <td>
                                        <div id="ctl00_ContentPlaceHolder1_ASPxRoundPanel1_txtUserName_ITip" style="width: 250px; display: inline;">
                                        </div>
                                    </td>
                                </tr>
                            </table>
                    ...
                    <tr>
                        <td style="width: 100px; text-align: right">栏目描述：
                        </td>
                        <td style="text-align: left;">
                            <input id="txtContent" runat="server" />（固定）
                            <br />
                            <input id="txtContent1" runat="server" />（自增）
                             <input id="txtContent2" visible="false" runat="server" />
                        </td>
                    </tr>
                    <tr>
