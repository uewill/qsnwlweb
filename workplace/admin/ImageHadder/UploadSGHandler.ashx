<%@ WebHandler Language="C#" Class="UploadSGHandler" %>

using System;
using System.Web;

public class UploadSGHandler : IHttpHandler
{
    private static readonly log4net.ILog log = log4net.LogManager.GetLogger(typeof(UploadSGHandler));
    ...
    private void UpLoadImages(HttpContext context)
    {
        ...
        if (file != null)
        {
            try
            {
                ...
                string saveDir = "../../sguploads/" + toFolder; //文件保存文件夹
                ...
                try
                {
                    string oldfullpath = pageDoc.Server.MapPath("../../sguploads/" + toFolder + oldPath);
    ...
    {
        TFXK.Common.Thumbnail.CreateThumbnail(width, height, fromPath, fromPath.Replace("sguploads", "sguploads_thum"));
        TFXK.Common.WaterMark doMark = new TFXK.Common.WaterMark();
    }
    #endregion
