<%@ Page Language="C#" MasterPageFile="~/admin/MainPage/ItemMasterPage.master" AutoEventWireup="true"
    CodeFile="Default.aspx.cs" Inherits="admin_ProductsManage_Default" Title="文章内容" %>
            ...
            <td>
                <table class="maincon" width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#CCCCCC">
                    <tr>
                        ...
                        <th width="20%" background="../images/bg.gif" align="center">
                            名称
                        </th>
                    ...
                    <asp:Repeater ID="rptBind" runat="server">
                        <ItemTemplate>
                            <tr>
                                ...
                                <td align="center">
                                    <input type="text" id="txtClicks" style="width: 40px; text-align: center; border: solid 1px #CCC;"
                                        value='<%# Eval("clicks") %>' runat="server" />
                                </td>
                                <td align="center">
                                    <%# Eval("title") %>
                                </td>
                                ...
                                <td align="center">
                                    <%#SetTuiJian(Eval("istuijian"),Eval("id"))%>
                                </td>
                                <td align="center">
                                    <%#SetHot(Eval("ishot"), Eval("id"))%>
                                </td>
                                 <td align="center">
                                    <%#SetCX(Eval("desFild1"), Eval("id"))%>
                                </td>
                                <td align="center">
                                    <img src="../images/edt.gif" onclick="javascript:location='Action.aspx?type=modify&id=<%# Eval("id") %>&codeNo=<%# Eval("pcodeNo") %>';return false;"
                        ...
                        <td width="60">
                            <table width="90%" border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    ...
                                    <td>
                                        <div align="center">
                                            <asp:LinkButton ID="lbtnModifyRQ" runat="server" OnClick="lbtnModifyRQ_Click">更新人气</asp:LinkButton>
                                        </div>
                                    </td>
                                </tr>
                            </table>
