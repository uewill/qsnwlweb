<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PrintViewby.aspx.cs" Inherits="Exam_personal_PrintViewby" %>
        ...
        <div style="width: 210mm; height: 297mm; background-image: url('./printimgs/gmkj.jpg'); background-repeat: no-repeat; background-size: contain;">
            <table style="padding-top: 190px; ">
                ...
                <tr style="height: 42px; vertical-align: bottom">
                    ...
                    <td></td>
                    <td colspan="2" style="padding-left: 70px;"><%=examModel.ContactorPhone %></td>
                </tr>
                <tr style="height: 40px; vertical-align: bottom">
                    <td></td>
                    ...
                    <td style="padding-left:20px;"><%=examModel.HaveMaxLevel %></td>
                </tr>
