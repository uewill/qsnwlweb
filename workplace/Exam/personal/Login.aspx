                    ...
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <ul class="nav nav-tabs">
                                ...
                                <li role="presentation" class="active"><a style="font-size: 18px;" href="/exam/personal/Login.aspx">考生登录</a></li>
                            </ul>
                            <div class="row" style="padding-top: 10px;">
                                <div class="col-md-9">
                                    <form runat="server">
                                        <div class="form-group">
                                            <label for="txtName">考生姓名或手机号</label>
                                            <input type="text" class="form-control" id="txtName" runat="server" placeholder="考生姓名或手机号">
                                        </div>
                                        <div class="form-group">
                                    ...
                                    <label>
                                        ...
                                        <button type="button" runat="server" id="btnLogin" onserverclick="btnLogin_ServerClick" style="width: 120px;" class="btn btn-success">登录</button>
                                                                             <a style="width: 100px;" class="btn btn-link" href="../ForgetPassword.aspx?type=1">忘记密码？</a>
                                        <a style="width: 100px;" class="btn btn-link" href="Register.aspx">注册考生？</a>
