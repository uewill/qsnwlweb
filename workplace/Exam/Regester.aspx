<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Regester.aspx.cs" Inherits="Exame_Regester" %>
...
<head>
    ...
    <title>中国美术学院考级中心-成都考区承办单位四川金色年华艺术中心-注册</title>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-body">
                                <ul class="nav nav-tabs">
                                    <li role="presentation" class="active"><a style="font-size: 18px;" href="/exam/Regester.aspx">考点注册</a></li>
                                    <li role="presentation"><a href="/exam/personal/Register.aspx">考生注册</a></li>
                                </ul>
                                ...
                                <div class="row">
                                    <div class="col-md-9">
                                        <div class="form-group">
                                            ...
                                            <input id="txtName" runat="server" type="text" class="form-control" placeholder="考点名称">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">登录密码 <span style="color: red">*</span></label>
                                            <input id="txtPass" runat="server" type="password" class="form-control" placeholder="登录密码">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <button type="button" id="btnReg" runat="server" onserverclick="btnReg_ServerClick" style="width: 120px;" class="btn btn-success">注册</button>
                                        <a style="width: 120px;" class="btn btn-link" href="Login.aspx">已有帐号,直接登录？</a>
                                    </div>
                                </div>
                            </div>
                        </div>
