...
namespace TFXK.BLL
{
	...
	{
		private readonly ITestingPersonPlan dal=DataAccess.CreateTestingPersonPlan();
		...
		/// 获得数据列表
		/// </summary>
		public List<TFXK.Model.TestingPersonPlan> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<TFXK.Model.TestingPersonPlan> DataTableToList(DataTable dt)
		{
			List<TFXK.Model.TestingPersonPlan> modelList = new List<TFXK.Model.TestingPersonPlan>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
                TFXK.Model.TestingPersonPlan model;
        ...
        {
            DataSet ds = bll.GetList("[tb_TestingPersonPlan]", "id", "*", PageSize, PageIndex, where, "ordernum desc,id desc", out rowCount);
            return ds;
        }
        ...
        {
            return GetList("[tb_TestingPersonPlan]", PageSize, PageIndex, "", "ordernum desc, id desc", out rowCount);
        }
