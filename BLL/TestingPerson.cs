...
namespace TFXK.BLL
{
	...
	{
		private readonly ITestingPerson dal=DataAccess.CreateTestingPerson();
        ...
        {
            return dal.GetModelByPhone(phoneNumber);
        }
		...
		/// 获得数据列表
		/// </summary>
		public List<TFXK.Model.TestingPerson> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<TFXK.Model.TestingPerson> DataTableToList(DataTable dt)
		{
			List<TFXK.Model.TestingPerson> modelList = new List<TFXK.Model.TestingPerson>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				TFXK.Model.TestingPerson model;
