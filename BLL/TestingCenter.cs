...
namespace TFXK.BLL
{
    ...
    {
        private readonly ITestingCenter dal = DataAccess.CreateTestingCenter();
        ...
        {
            model.UserPass = Security.EncryptDES(model.UserPass, "UEMASTER");
        ...
        /// 获得数据列表
        /// </summary>
        public List<TFXK.Model.TestingCenter> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<TFXK.Model.TestingCenter> DataTableToList(DataTable dt)
        {
            List<TFXK.Model.TestingCenter> modelList = new List<TFXK.Model.TestingCenter>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                TFXK.Model.TestingCenter model;
        ...
        {
            return GetList("[tb_TestingCenter]", PageSize, PageIndex, where, "id desc", out rowCount);
        }
