...
namespace TFXK.SQLServerDAL
{
	...
	/// 数据访问类UserOrdersDAL。
	/// </summary>
	public class UserOrdersDAL:IUserOrdersDAL
	{
		public UserOrdersDAL()
		{}
		#region  成员方法
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "tb_UserOrders"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from tb_UserOrders");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into tb_UserOrders(");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update tb_UserOrders set ");
		...
		public void Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from tb_UserOrders ");
			strSql.Append(" where id=@id ");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)};
			parameters[0].Value = id;
		...
		public TFXK.Model.UserOrders GetModel(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,typeID,Jijie,chkOrderNum,orderNum,hopePrice,proCode,otherDes,filePaths,contactUserName,userSex,userTel,userPhone,userEmail,companyName,companyAddress,stateID,des1,des2,des3,des4 from tb_UserOrders ");
			strSql.Append(" where id=@id ");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)};
			parameters[0].Value = id;
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM tb_UserOrders ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "tb_UserOrders";
